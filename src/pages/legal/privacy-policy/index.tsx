  ...
  return (
    <Layout title={"Privacy Policy"} description="Clickity-click, it's Sitekick!">
      <main className="w-80 m-3a">
        ...
        <ul>
          <li>Visit our website at <Link to="https://sitekickremastered.com/" target="_blank" data-custom-class="link">https://sitekickremastered.com/</Link>, or any website of ours that links to this privacy notice.</li>
          <li>Download and use our mobile application (Sitekick Remastered), or any other application of ours that links to this privacy notice.</li>
          <li>Participate in our "YAP! Message Boards" powered by NodeBB (the "<b>Forum</b>"), accessible through our website or application.</li>
          <li>Engage with us in other related ways, including any sales, marketing, or events.</li>
        </ul>
        <Heading as="h4">Questions or concerns?</Heading>
        <p>Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <Link to="mailto:admin@sitekickremastered.com" target="_blank">admin@sitekickremastered.com</Link>.</p>

        <br />
        <Heading as="h2">Summary of Key Points</Heading>
        <p><b><i>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our <Link to="#toc">table of contents</Link> below to find the section you are looking for.</i></b></p>

        <Heading as="h4">What personal information do we process?</Heading>
        <p>When you visit, use, or navigate our Services, including the Forum, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about <Link to="#personalInfo">personal information you disclose to us</Link>.</p>

        <Heading as="h4">Do we process any sensitive personal information?</Heading>
        <p>We do not process sensitive personal information.</p>

        <Heading as="h4">Do we receive any information from third parties?</Heading>
        <p>We do not receive any information from third parties.</p>

        <Heading as="h4">How do we process your information?</Heading>
        ...
        <Heading as="h4">What are your rights?</Heading>
        <p>Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn more about <Link to="#privacyRights">your privacy rights</Link>.</p>

        <Heading as="h4">How do you exercise your rights?</Heading>
        <p>The easiest ways to exercise your rights is by visiting <Link to="/docs/tutorials/delete_account">sitekickremastered.com/docs/tutorials/delete_account</Link>, or by contacting us at <Link to="mailto:admin@sitekickremastered.com" target="_blank">admin@sitekickremastered.com</Link>. We will consider and act upon any request in accordance with applicable data protection laws.</p>

        <p>Want to learn more about what we do with any information we collect? <Link to="#toc">Review the privacy notice in full</Link>.</p>

        <Heading as="h2" id="toc">Table of Contents</Heading>
        <ol>
          <li><Link to="#infoCollect">What Information Do We Collect?</Link></li>
          <li><Link to="#infoUse">How Do We Process Your Information?</Link></li>
          <li><Link to="#legalBases">What Legal Bases Do We Rely On to Process Your Personal Information?</Link></li>
          <li><Link to="#whoShare">When and With Whom Do We Share Your Personal Information?</Link></li>
          <li><Link to="#cookies">Do We Use Cookies and Other Tracking Technologies?</Link></li>
          <li><Link to="#infoRetain">How Long Do We Keep Your Information?</Link></li>
          <li><Link to="#infoSafe">How Do We Keep Your Information Safe?</Link></li>
          <li><Link to="#privacyRights">What Are Your Privacy Rights?</Link></li>
          <li><Link to="#DNT">Controls for Do-Not-Track Features</Link></li>
          <li><Link to="#usLaws">Do United States Residents Have Specific Privacy Rights?</Link></li>
          <li><Link to="#policyUpdates">Do We Make Updates to This Notice?</Link></li>
        ...
        <Heading as="h4">Application Data</Heading>
        ...
        <ul>
          ...
          <li><i>Push Notifications.</i> We may request to send you push notifications regarding your account or certain features of the application(s), including Forum activity. If you wish to opt out from receiving these types of communications, you may turn them off in your device's settings.</li>
        </ul>
        ...
        <ul>
          ...
          <li><i>Device Data.</i> We collect device data such as information about your computer, phone, tablet, or other device you use to access the Services, including the Forum. Depending on the device used, this device data may include information such as your IP address (or proxy server), device and application identification numbers, location, browser type, hardware model, Internet service provider and/or mobile carrier, operating system, and system configuration information.</li>
        </ul>

        <br />
        <Heading as="h2" id="infoUse">2. How Do We Process Your Information?</Heading>
        ...
        <ul>
          <li><b>To facilitate account creation and authentication and otherwise manage user accounts.</b> We may process your information so you can create and log in to your account, including your Forum profile, as well as keep your account in working order.</li>
        ...
        <br />
        <Heading as="h2" id="legalBases">3. What Legal Bases Do We Rely On To Process Your Personal Information?</Heading>
        ...
        <p>We may process your information if you have given us specific permission (i.e., express consent) to use your personal information for a specific purpose, such as participating in the Forum, or in situations where your permission can be inferred (i.e., implied consent). You can <Link to="#withdrawConsent">withdraw your consent</Link> at any time.</p>
        ...
        <br />
        <Heading as="h2" id="whoShare">4. When and With Whom Do We Share Your Personal Information?</Heading>
        ...
        <p>We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy notice, unless a longer retention period is required or permitted by law (such as tax, accounting, or other legal requirements). No purpose in this notice will require us keeping your personal information, such as account details and Forum profile information, for longer than the period of time in which users have an account with us. However, Forum posts you create may be retained indefinitely, even after account deletion, as they are considered public contributions to the Services.</p>
        <p>When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize such information, or, if this is not possible (for example, because your personal information has been stored in backup archives), then we will securely store your personal information and isolate it from any further processing until deletion is possible.</p>

        <br />
        <Heading as="h2" id="infoSafe">7. How Do We Keep Your Information Safe?</Heading>
        ...
        <p>We have implemented appropriate and reasonable technical and organizational security measures designed to protect the security of any personal information we process. However, despite our safeguards and efforts to secure your information, no electronic transmission over the Internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Although we will do our best to protect your personal information, transmission of personal information to and from our Services, including the Forum, is at your own risk. You should only access the Services within a secure environment.</p>

        <br />
        <Heading as="h2" id="privacyRights">8. What Are Your Privacy Rights?</Heading>
        <p><i><b>In Short:</b> In some regions, such as Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</i></p>
        ...
        <Heading as="h6" id="withdrawConsent"><u>Withdrawing your consent</u></Heading>
        ...
        <br />
        <Heading as="h2" id="DNT">9. Controls for Do-Not-Track Features</Heading>
        ...
        <br />
        <Heading as="h2" id="usLaws">10. Do United States Residents Have Specific Privacy Rights?</Heading>
        <p><i><b>In Short:</b> Depending on your state, you are granted specific rights regarding access to your personal information. If you would like to exercise those rights, please <Link to="#contact">contact us</Link>.</i></p>
        <Heading as="h6">What categories of personal information do we collect?</Heading>
        ...
        <p>We will use and retain the collected personal information as needed to provide the Services or for <b>Category A - As long as the user has an account with us; Forum posts may be retained indefinitely</b>.</p>
        <p>We may also collect other personal information outside of these categories through instances where you interact with us in person, online, or by phone or mail in the context of:</p>
        <ul>
          <li>Receiving help through our customer support channels;</li>
          <li>Participation in customer surveys or contests; and</li>
          <li>Facilitation in the delivery of our Services, including Forum participation, and to respond to your inquiries.</li>
        </ul>
        <p><b>How do we use and share your personal information?</b></p>
        <p>Learn about how we use your personal information in the section, <Link to="#infoUse">"How Do We Process Your Information?"</Link></p>
        <p><b>Will your information be shared with anyone else?</b></p>
        <p>We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider. Learn more about how we disclose personal information to in the section, <Link to="#whoShare">"When And With Whom Do We Share Your Personal Information?"</Link>.</p>
        ...
        <br />
        <Heading as="h2" id="policyUpdates">11. Do We Make Updates to This Notice?</Heading>
        ...
        <br />
        <Heading as="h2" id="contact">12. How Can You Contact Us About This Notice?</Heading>
        <p>If you have questions or comments about this notice, you may email us at <Link to="mailto:admin@sitekickremastered.com" target="_blank">admin@sitekickremastered.com</Link>.</p>

        <br />
        <Heading as="h2" id="request">13. How Can You Review, Update, or Delete the Data We Collect From You?</Heading>
        <p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: <Link to="/docs/tutorials/delete_account">sitekickremastered.com/docs/tutorials/delete_account</Link>. Upon account deletion, your Forum profile and associated personal information will be removed from our active databases, but Forum posts will remain accessible as public contributions to the Services.</p>
      </main>
    </Layout>
  );
}