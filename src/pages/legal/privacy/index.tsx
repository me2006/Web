  ...
  return (
    <Layout title={"Privacy Policy"} description="Clickity-click, it's Sitekick!">
      <main style={{ width: "80%", margin: "3rem auto" }}>
        ...
        <br />
        <Heading as="h6">Last updated May 11, 2024</Heading>
        ...
        <p>When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about <Link to="#personalInfo">personal information you disclose to us</Link>.</p>
        ...
        <p>We may share information in specific situations and with specific third parties. Learn more about <Link to="#whoShare">when and with whom we share your personal information</Link>.</p>
        ...
        <p>We may process your information if you have given us specific permission (i.e., express consent) to use your personal information for a specific purpose, or in situations where your permission can be inferred (i.e., implied consent). You can <Link to="#withdrawConsent">withdraw your consent</Link> at any time.</p>
        ...
        <ul>
          ...
          <li><b>Other Users.</b> When you share personal information or otherwise interact with public areas of the Services, such personal information may be viewed by all users and may be publicly made available outside the Services in perpetuity. Similarly, other users will be able to view descriptions of your activity, communicate with you within our Services, and view your profile.</li>
        </ul>
        ...
        <p>If you would at any time like to review or change the information in your account or terminate your account, you can contact us using the contact information <Link to="#contact">provided on this website and within this document</Link>.</p>
        <p>Upon your request to terminate your account, we will deactivate or delete your account and information from our active databases. However, we may retain some information in our files to prevent fraud, troubleshoot problems, assist with any investigations, enforce our legal terms and/or comply with applicable legal requirements.</p>
        <p><b><u>Cookies and similar technologies:</u></b> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see <Link to="/legal/cookies">our Cookie Notice</Link>.</p>
        ...
        <p>We will use and retain the collected personal information as needed to provide the Services or for <b>Category A - As long as the user has an account with us</b>.</p>
        ...
        <p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: <Link to="/docs/tutorials/delete_account">sitekickremastered.com/docs/tutorials/delete_account</Link>.</p>
      </main>
    </Layout>
  );
}