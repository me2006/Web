  ...
  return ( 
    <Layout title={`Cookies Policy`} description="Clickity-click, it's Sitekick!">
      <main style={{width: "80%", margin: "3rem auto"}}>
        ...
        <p>If you have any questions about our use of cookies or other technologies, please contact us at: <a href="mailto:admin@sitekickremastered.com" target="_blank">admin@sitekickremastered.com</a>.</p>
      </main>
    </Layout>
); 
}