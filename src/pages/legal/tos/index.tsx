  ...
  return (
    <Layout title={`Cookies Policy`} description="Clickity-click, it's Sitekick!">
      <main style={{ width: "80%", margin: "3rem auto" }}>
        ...
        <br />
        <h6>Last updated May 11, 2024</h6>

        <br />
        <p>We are the Sitekick Remastered Team("<b>we</b>," "<b>us</b>," and "<b>our</b>").</p>
        <p>We operate the website <a href="/">https://sitekickremastered.com</a> (the "<b>Site</b>"), the mobile application Sitekick Remastered (the "<b>App</b>"), as well as any other related products and services that refer or link to these legal terms (the "<b>Legal Terms</b>") (collectively, the "<b>Services</b>").</p>
        <p>You can contact us by email at <a href="mailto:admin@sitekickremastered.com" target="_blank">admin@sitekickremasterd.com</a>.</p>
        ...
        <p>Subject to your compliance with these Legal Terms, including the "<a href="#prohibited">Prohibitied Activities</a>" section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
        <ul>
        ...
        <p>Please review this section and the "<a href="#prohibited">Prohibitied Activities</a>" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
        ...
        <ul>
          <li>confirm that you have read and agree with our "<a href="#prohibited">Prohibitied Activities</a>" and will not post, send, publish, upload, or transmit through the Services any Submission that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
        ...
        <br />
        <h2 id="prohibited">5. Prohibitied Activities</h2>
        ...
        <h4>Information Negotiations</h4>
        ...
        <br/>
        <h2 id="limitations">19. Limitations of Liability</h2>
        ...
        <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at: <a href="mailto:admin@sitekickremastered.com" target="_blank">admin@sitekickremastered.com</a>.</p>
      </main>
    </Layout>
  );
}