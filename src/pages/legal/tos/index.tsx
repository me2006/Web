  ...
  return (
    <Layout title={"Terms of Service"} description="Clickity-click, it's Sitekick!">
      <main style={{ width: "80%", margin: "3rem auto" }}>
        ...
        <br/>
        <Heading as="h2" id="limitations">19. Limitations of Liability</Heading>
