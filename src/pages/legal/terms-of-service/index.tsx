  ...
  return (
    <Layout title={"Terms of Service"} description="Clickity-click, it's Sitekick!">
      <main className="w-80 m-3a">
        ...
        <p>We operate the website <Link to="/">https://sitekickremastered.com</Link> (the "<b>Site</b>"), the mobile application Sitekick Remastered (the "<b>App</b>"), as well as any other related products and services that refer or link to these legal terms (the "<b>Legal Terms</b>") (collectively, the "<b>Services</b>").</p>
        <p>You can contact us by email at <Link to="mailto:admin@sitekickremastered.com" target="_blank">admin@sitekickremasterd.com</Link>.</p>
        <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("<b>you</b>"), and The Sitekick Remastered Team, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
        ...
        <ol>
          ...
          <li><Link to="#ip">Intellectual Property Rights</Link></li>
          <li><Link to="#userReps">User Representations</Link></li>
          <li><Link to="#userReg">User Registration</Link></li>
          <li><Link to="#prohibited">Prohibited Activities</Link></li>
          <li><Link to="#ugc">User Generated Contributions</Link></li>
          <li><Link to="#license">Contribution License</Link></li>
          <li><Link to="#mobile">Mobile Application License</Link></li>
          <li><Link to="#socialMedia">Social Media</Link></li>
          <li><Link to="#thirdParty">Third-Party Websites and Content</Link></li>
          <li><Link to="#siteManage">Services Management</Link></li>
          <li><Link to="#privacyPolicy">Privacy Policy</Link></li>
          <li><Link to="#terms">Term and Termination</Link></li>
          <li><Link to="#modifications">Modifications and Interruptions</Link></li>
          <li><Link to="#law">Governing Law</Link></li>
          <li><Link to="#disputes">Dispute Resolution</Link></li>
          <li><Link to="#corrections">Corrections</Link></li>
          <li><Link to="#disclaimer">Disclaimer</Link></li>
          <li><Link to="#liability">Limitations of Liability</Link></li>
          <li><Link to="#indemnification">Indemnification</Link></li>
          <li><Link to="#userData">User Data</Link></li>
          <li><Link to="#electronic">Electronic Communications, Transactions, and Signatures</Link></li>
          <li><Link to="#california">California Users and Residents</Link></li>
          <li><Link to="#misc">Miscellaneous</Link></li>
          <li><Link to="#contact">Contact Us</Link></li>
        </ol>

        <br />
        <Heading as="h2" id="services">1. Our Services</Heading>
        ...
        <br />
        <Heading as="h2" id="ip">2. Intellectual Property Rights</Heading>
        <Heading as="h4">Our intellectual property</Heading>
        <p>We are the owner or the licensee of some of the intellectual property rights in our Services, including all source code, databases, functionality, software, website designs, video, text, and some graphics in the Services (collectively, the "Content").</p>
        ...
        <Heading as="h4">Your use of our Services</Heading>
        <p>Subject to your compliance with these Legal Terms, including the "<Link to="#prohibited">Prohibitied Activities</Link>" section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
        <ul>
        ...
        <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: admin@sitekickremastered.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
        <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
        <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>
        <Heading as="h4">Your submissions</Heading>
        <p>Please review this section and the "<Link to="#prohibited">Prohibitied Activities</Link>" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
        ...
        <p><b>You are responsible for what you post or upload:</b> By sending us Submissions through any part of the Services you:</p>
        <ul>
          <li>confirm that you have read and agree with our "<Link to="#prohibited">Prohibitied Activities</Link>" and will not post, send, publish, upload, or transmit through the Services any Submission that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
        ...
        <br />
        <Heading as="h2" id="userReps">3. User Representations</Heading>
        ...
        <br />
        <Heading as="h2" id="userReg">4. User Registration</Heading>
        ...
        <br />
        <Heading as="h2" id="prohibited">5. Prohibitied Activities</Heading>
        ...
        <br />
        <Heading as="h2" id="ugc">6. User Generated Contributions</Heading>
        ...
        <br />
        <Heading as="h2" id="license">7. Contribution License</Heading>
        ...
        <br/>
        <Heading as="h2" id="mobile">8. Mobile Application License</Heading>
        <Heading as="h4">Use License</Heading>
        ...
        <Heading as="h4">Apple and Android Devices</Heading>
        ...
        <br/>
        <Heading as="h2" id="socialMedia">9. Social Media</Heading>
        ...
        <br/>
        <Heading as="h2" id="thirdParty">10. Third-Party Websites and Content</Heading>
        ...
        <br/>
        <Heading as="h2" id="siteManage">11. Services Management</Heading>
        ...
        <br/>
        <Heading as="h2" id="modifications">14. Modifications and Interruptions</Heading>
        ...
        <br/>
        <Heading as="h2" id="law">15. Governing Law</Heading>
        <p>These Legal Terms shall be governed by and defined following the laws of Canada. The Sitekick Remastered Team and yourself irrevocably consent that the courts of Canada shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>

        <br/>
        <Heading as="h2" id="disputes">16. Dispute Resolution</Heading>
        <Heading as="h4">Information Negotiations</Heading>
        ...
        <Heading as="h4">Binding Arbitration</Heading>
        <p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be 1. The seat, or legal place, or arbitration shall be Canada. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of Canada.</p>
        <Heading as="h4">Restrictions</Heading>
        <p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.</p>
        <Heading as="h4">Exceptions to Informal Negotiations and Arbitration</Heading>
        ...
        <br/>
        <Heading as="h2" id="corrections">17. Corrections</Heading>
        <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>

        <br/>
        <Heading as="h2" id="disclaimer">18. Disclaimer</Heading>
        ...
        <br/>
        <Heading as="h2" id="liability">19. Limitations of Liability</Heading>
        ...
        <br/>
        <Heading as="h2" id="indemnification">20. Indemnification</Heading>
        ...
        <br/>
        <Heading as="h2" id="userData">21. User Data</Heading>
        <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

        <br/>
        <Heading as="h2" id="electronic">22. Electronic Communications, Transactions, and Signatures</Heading>
        ...
        <br/>
        <Heading as="h2" id="california">23. California Users and Residents</Heading>
        <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>

        <br/>
        <Heading as="h2" id="misc">24. Miscellaneous</Heading>
        ...
        <br/>
        <Heading as="h2" id="contact">25. Contact Us</Heading>
        <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at: <Link to="mailto:admin@sitekickremastered.com" target="_blank">admin@sitekickremastered.com</Link>.</p>
      </main>
    </Layout>
  );
}