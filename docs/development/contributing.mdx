# Contributing
Everyone is able to contribute to Sitekick Remastered's Website, Discord Bots, and Art repository.  In order to keep some things a surprise, the Game repository is private, but it will be mostly open source at a later date.
...
### 2. Clone Your Repo
:::warning
You will need a Git client.  For this tutorial we will be using [Sourcetree](https://www.sourcetreeapp.com/).  If you are familiar with this step, proceed to the next section.
:::
