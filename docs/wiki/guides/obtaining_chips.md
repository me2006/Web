Chips are obtained through three different methods.  Chips are primarily spawned in the dump at the moment, but will transition to being obtained from different methods in the future.
