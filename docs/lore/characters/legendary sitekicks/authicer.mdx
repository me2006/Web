...
<div className="row wiki-parent">
    ...
    <div className="col wiki-infobox-col">
        <InfoBox 
            ...
            categories={
                {
                "Affiliation:": "The first sitekick made by the Sitekick Remastered Team from Dr. Frantic's schematics.",
                "Fun Fact:": "[GM] Nicholas's dad joke became a functional tool.",
