...
From the MAIN or CHIPS tab, select the top left menu, settings, then select "Rename Sitekick".

## Changing your Sitekick's color
From the MAIN or CHIPS tab, select the top left menu, settings, then select "Paint Sitekick".
