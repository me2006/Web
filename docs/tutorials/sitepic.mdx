...
<video width="80%" height="80%" controls style={{display: "flex", margin: "auto"}}>
  <source src="https://github.com/SitekickRemastered/SitePic/assets/1341176/04a8aa75-7cce-4161-b416-b7bead119d3f" type="video/mp4" />
</video>
